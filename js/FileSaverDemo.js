...
var
	...
	, canvas = $("SaveCanvas")
	, canvas_options_form = $("SaveCanvas-options")
	, canvas_filename = $("SaveCanvas-filename")
	, canvas_clear_button = $("SaveCanvas-clear")

	, text = $("SaveCanvas-text")
	, text_options_form = $("SaveCanvas-text-options")
	, text_filename = $("SaveCanvas-text-filename")
